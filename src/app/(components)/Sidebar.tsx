...
import { User, Briefcase, FolderGit, Moon, Sun, FileText, Search, X, Network } from "lucide-react";
...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      timeoutId = setTimeout(() => setIsVisible(false), HIDE_DELAY_MS);
    };
  ...
  return (
    <aside
      className={clsx(
        ...
        /* Light: off-white #f9f9fb | Dark: brand navy #0b0d2a */
